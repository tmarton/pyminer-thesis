...
\par RNDr. Daniel Tovarňák preto vyvinul algoritmus Extended Nagappan-Vouk určený pre použitie v RURC, ktorý bude spĺnať všetky požiadavky RURC a zároveň bude jednoduchšie nastaviteľný ako LogCluster. Algoritmus produkuje parsovacie vzory vo formáte, ktorý popisuje paramter ako \emph{\%\{m,n\}} $\%\{m,n\}$. Podobne ako pri LogClustry to označuje \emph{m} až \emph{n} za sebou idúcich tokenov. Napr. parsovací vzor \emph{Software caused \%\{1,3\}} zachytí správu ktorá obsahuje text \emph{Software caused} nasledovaný 1 až 3 slovami oddelenými medzerou. \par Postup algoritmu:
...
\begin{figure}[htbp]
 ...
 \begin{minipage}{0.95\linewidth}
 	\centering
 	\missingfigure[figheight=6cm]{Text}
 	%\includegraphics[width=\textwidth]{images/RURC.png} 	
 \end{minipage}
