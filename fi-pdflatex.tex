...
\thesislong{abstract}{
    Táto diplomová práca sa zaoberá odhaľovaním parsovacích vzorov systémových logov, konkrétne algoritmom Extended Nagappan-Vouk. Práca takisto vyhodnocuje a implementuje webové užíveteľské roz\-hra\-nie pre tento algoritmus.
}
\thesislong{thanks}{
